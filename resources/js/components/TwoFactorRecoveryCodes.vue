    ...
    <Card class="w-full">
        <CardHeader>
            ...
            <CardDescription>
                ...
                perdés tu dispositivo 2FA. Guardalos en un gestor de
                contraseñas.
            </CardDescription>
        </CardHeader>
        <CardContent>
            ...
            >
                ...
                <div v-else class="mt-3 space-y-3">
                    ...
                    <p class="text-xs text-muted-foreground select-none">
                        Cada código sirve una sola vez para acceder a tu cuenta
                        y se elimina después de usarlo. Si necesitás más, tocá
