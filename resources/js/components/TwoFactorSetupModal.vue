...
const modalConfig = computed<TwoFactorConfigContent>(() => {
    if (props.twoFactorEnabled) {
        return {
            ...
            description:
                'Ya está activa. Escaneá el código QR o ingresá la clave manual en tu app de autenticación.',
            buttonText: 'Cerrar',
        };
    }
    ...
    return {
        ...
        description:
            'Para terminar de activarla, escaneá el código QR o ingresá la clave manual en tu app de autenticación',
        buttonText: 'Continuar',
    };
});
                    ...
                    <template v-else>
                        ...
                        >
                            ...
                            <span class="relative bg-card px-2 py-1"
                                >o ingresá la clave manualmente</span
                            >
                        </div>
